...
export declare const updateGroupSettings: (req: AuthenticatedRequest, res: Response, next: NextFunction) => Promise<void>;
...
export declare const uploadChatAttachment: (req: AuthenticatedRequest, res: Response, next: NextFunction) => Promise<void>;
