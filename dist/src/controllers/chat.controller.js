...
exports.uploadChatAttachment = exports.leaveGroup = exports.removeGroupMember = exports.addGroupMembers = exports.updateGroupSettings = exports.createGroup = exports.getGroupMessages = exports.getGroups = exports.getMessages = exports.getConversations = void 0;
...
const updateGroupSettings = async (req, res, next) => {
    try {
        ...
        const group = await group_service_1.groupService.updateGroup(groupId, employee._id.toString(), { name, description });
