...
router.post('/start-break', attendance_controller_1.startBreak);
router.post('/end-break', attendance_controller_1.endBreak);
router.get('/export', attendance_controller_1.exportAttendance);
